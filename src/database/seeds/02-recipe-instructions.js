exports.seed = kn => {
  return kn("recipe_instructions")
    .truncate()
    .then(() => {
      return kn("recipe_instructions").insert([
        {
          step: 1,
          instruction:
            "Reheat oven to 350F. Butter and flour 13x18x1-inch sheet pan. Line with foil or parchment that hangs over the sides for ease in getting them out (butter the foil/parchment).",
          recipe_id: 1
        },
        {
          step: 2,
